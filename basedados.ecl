...
unidade_curr(1,'Introducao a Programacao',1,2).
unidade_curr(2,'Matematica I',1,2).
unidade_curr(5,'Estruturas de Dados',1,2).
unidade_curr(6,'Matematica II',1,2).
unidade_curr(3,'Estruturas Discretas',1,2).
unidade_curr(4,'Introducao aos Computadores',1,1).
unidade_curr(7,'Desenho e Analise de Algoritmos',2,3).
unidade_curr(8,'Probabilidades e Estatistica',2,2).
unidade_curr(9,'Analise Infinitesimal I',2,1).
unidade_curr(14,'Sistemas de Operacao',2,2).
unidade_curr(10,'Bases de Dados',2,2).
unidade_curr(11,'Metodos de Apoio a Decisao',3,2).
unidade_curr(12,'Computabilidade e Complexidade',3,2).
unidade_curr(13,'Compiladores',3,1).
